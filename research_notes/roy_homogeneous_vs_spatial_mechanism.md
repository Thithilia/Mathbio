...
Total compared grid points: 140.
Agreement fraction: 0.9.
Disagreements: 14.
Disagreements involving transient labels: 14.
Direct persistent/extinct disagreements: 0.
Dominant disagreement type: `ode_persistent_pde_transient`.
Interpretation: `disagreements_are_boundary_or_horizon_sensitive_and_do_not_overturn_reaction_dominated_label`.
